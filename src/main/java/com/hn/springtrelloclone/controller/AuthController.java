...
import com.hn.springtrelloclone.service.RefreshTokenService;
...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<String> signup(@RequestBody SignUpRequest registerRequest) {
        if(authService.userNotExist(registerRequest)){
